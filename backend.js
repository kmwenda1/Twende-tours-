...
const seedData = {
    ...
    fleet: [
        { id: 101, name: 'Safari Van', type: 'Van', rate: 18000, status: 'Available', seats: 8, bags: 8, image: 'https://images.unsplash.com/photo-1566008885171-2a2dd16688a3', description: 'Budget-friendly group safaris' },
        { id: 102, name: 'Land Cruiser Prado', type: 'SUV', rate: 25000, status: 'Available', seats: 6, bags: 6, image: 'https://images.unsplash.com/photo-1596707328637-409869323520', description: 'Comfortable mid-size SUV' },
        { id: 103, name: 'Land Cruiser 70', type: '4x4', rate: 30000, status: 'Booked', seats: 7, bags: 4, image: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf', description: 'Classic rugged 4x4' },
        { id: 104, name: 'Land Cruiser V8', type: '4x4', rate: 35000, status: 'Available', seats: 6, bags: 6, image: 'https://images.unsplash.com/photo-1570125909232-eb263c188f7e', description: 'Luxury safari vehicle' },
        { id: 105, name: 'Toyota Hiace', type: 'Bus', rate: 22000, status: 'Available', seats: 14, bags: 10, image: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957', description: 'Large capacity van' },
        { id: 106, name: 'Land Cruiser VX', type: 'SUV', rate: 40000, status: 'Maintenance', seats: 7, bags: 7, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64', description: 'Top luxury SUV' }
    ],
    inquiries: [],
    bookings: [],
    payments: []
